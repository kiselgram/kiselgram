...
(function() {
    ...
    console.log('✨ Kiselgram Premium v4.3');
    ...
    function renderStoryViewer() {
        ...
        v.innerHTML = `
            <div class="story-viewer-header">
                ...
                <div class="story-viewer-user">
                    ...
                    <div class="story-viewer-info">
                        <span class="story-viewer-name" onclick="openUserProfileModalFromStory(${story.user_id})">${escapeHtml(window.currentStoryUser.display_name)}</span>
            ...
            <div class="story-viewer-content">
                ${story.media_type === 'video' ? `<video src="${story.media_url}" autoplay loop muted></video>` : `<img src="${story.media_url}" alt="story">`}
    ...
    window.deleteCurrentStory = async () => {
        ...
        try { const r = await fetch(`/api/stories/${s.id}`, { method: 'DELETE' });
            if (r.ok) { closeStoryViewer(); loadStories(); }
        } catch (e) {}
    };
