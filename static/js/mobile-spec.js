...
(function() {
    ...
    window.openChat = async function(type, id) {
        ...
        // Show chat view as full-screen overlay
        if (chatView) {
    ...
    // Observer to ensure back button is added when chat view appears
    ...
    // Force initial state: show empty chat, hide everything else, prevent auto-open
    document.addEventListener('DOMContentLoaded', () => {
        // Explicitly hide all panels and chat view
        ...
        // Override any pending chat open from URL
        setTimeout(() => {
            const chatView = document.getElementById('chatView');
            if (chatView && chatView.style.display === 'flex') {
                console.log('Forcing chat list view');
