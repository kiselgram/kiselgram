// static/js/free.js
// Kiselgram Free Edition – Full Nexgram Features (v4.2)
// Updated for SPA blueprint routes

(function() {
    'use strict';

    console.log('🍊 Kiselgram Free v4.2');
    ...
    window.activeChat = null;          // { type: 'personal'|'group'|'channel', id: ... }
    ...
    async function sendMessage() {
        ...
        const optimisticMsg = {
            id: tempId, content, sender_id: window.currentUserId,
            ...
            is_own: true, is_read: false, has_attachment: false, reactions: {}
        };
