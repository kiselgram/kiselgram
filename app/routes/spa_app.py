...
def sync_messages():
            """Accept a batch of messages created offline and persist them."""
            try:
                current_user_id = get_current_user_id()
                if not current_user_id:
                    return jsonify({'success': False, 'error': 'Not authenticated'}), 401
                ...
                for msg in messages:
                    ...
                    temp_id = msg.get('temp_id')  # client-side temporary ID
                    ...
                    synced.append({
                        ...
                        'message': message_to_dict(new_msg, current_user_id)
                    })
...
def send_push_notification(user_id, title, body, url='/'):
    """Call this after a new message arrives."""
